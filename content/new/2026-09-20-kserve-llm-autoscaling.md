---
title: "KServe provider now exposes LLM autoscaling with Web Validation Admission and HPA/KEDA"
...
summary: The KServe provider now supports automatic scaling of LLM inference workloads via Web Validation Admission hooks, Horizontal Pod Autoscaler, and KEDA triggers.
---

The KServe provider now supports automatic scaling for LLM inference workloads through Web Validation Admission (WVA), Horizontal Pod Autoscaler (HPA), and KEDA triggers.
